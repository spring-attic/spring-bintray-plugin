...
open class SpringBintrayExtension {
	...
	fun bintrayUser(p: Project): String? = bintrayUser ?: p.findProperty("bintrayUser") as String?

	fun bintrayKey(p: Project): String? = bintrayKey ?: p.findProperty("bintrayKey") as String?
